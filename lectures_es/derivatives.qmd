...
Great point — thanks for the clarification! Here's the revised version with proper `{python}` code block tags so it works in Quarto/Markdown environments like Jupyter Book, Quarto documents, or R Markdown:
